    ...
    <section id="about" className="py-20 px-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <a href={`${import.meta.env.BASE_URL}alex's__resume.pdf`} target="_blank" className="inline-flex items-center gap-2 border border-zinc-700 px-4 py-2 font-mono text-sm text-gray-300 hover:text-primary-400 hover:border-primary-500 transition-all">
            [ Download Resume ]
          </a>
        </div>
